...
<form id="form1" name="form1" method="post" action="">
  <table width="730" height="366" border="1" align="center">
    <tr>
      <td height="44" bgcolor="#FFFFFF"><h1><span class="style1">ADD</span></h1>      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO users(cashier,product,category, price) VALUES('$cashier','$product','$category', '$price')");

        // Show message when user added
        echo "product added successfully. <a href='6b.php'>View Product List</a>";
    }
	?>
</body>
</html>
